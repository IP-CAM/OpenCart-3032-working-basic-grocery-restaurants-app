...
class Mail
{
	public function send()
	{
		...
		// ini_set("SMTP", "StartTLS://smtp.gmail.com");
		// ini_set("smtp_port", "587");
		// ini_set("smtp_username", "maryjanecugal@gmail.com");
		// ini_set("smtp_password", "gwapaKo143!");
		// ini_set('sendmail_from', 'maryjanecugal@gmail.com');
